...
def test_scenarios_validate_and_list() -> None:
    ...
    # 49 shipped (40 public + 9 validation) + 13 self-authored scenarios under
    # scenarios/self_authored/ (8 from Phase 8 + 4 from the finance/enterprise
    # goal-consistency generalization check + 1 hybrid-integration
    # control-selector probe, soc_untrusted_control_selector.yaml).
    assert code == 0 and data["checked"] == 62 and data["failed"] == 0
