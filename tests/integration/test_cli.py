...
def test_scenarios_validate_and_list() -> None:
    ...
    # 28 shipped (19 public + 9 validation) + 8 self-authored Phase 8 scenarios under
    # scenarios/self_authored/ (SENTINEL_RESEARCH_PHASE8_VALIDATION.md).
    assert code == 0 and data["checked"] == 36 and data["failed"] == 0
